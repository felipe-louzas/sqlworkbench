...
{
  public static final String PROFILE_NAME = "WBJUnitDuckDb";

  public static WbConnection getDuckConnection()
  {
    try
    {
      ...
      parser.parse("-url='jdbc:duckdb:' -driver=org.duckdb.DuckDBDriver");
    ...
    {
      LogMgr.logError(new CallerInfo(){}, "Could not create DuckDB connection", th);
      return null;
    }
